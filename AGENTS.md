...
- 白色背景，标题和强调线条采用参考页的金色 `#C59114`（RGB 197 / 145 / 20），其余页面文字使用纯黑 `#000000`；保留参考网页的居中标题、作者、机构、资源链接和单列论文结构。
- 字体与用户个人网页 `assets/css/site-shell.css` 一致：`-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif`。标题使用个人网页的 600 / 500 字重，BibTeX 保留等宽字体。
